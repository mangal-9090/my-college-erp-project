...
<section class="contact">
    ...
    <div class="row">
        <form action="https://api.web3forms.com/submit" method="POST">
            ...
            <input type="text" name="full name" placeholder="full name" class="box" required>
            <input type="email" name="your email" placeholder="your email" class="box" required>
            <input type="password" name="your password" placeholder="your password" class="box" required>
            <input type="number" name="your number" placeholder="your number" class="box" required>
